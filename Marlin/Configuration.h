...
#define STRING_CONFIG_H_AUTHOR "(Marcos Alou, Tevo RNV2_1)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Tevo RNv2 2.0x"
...
// Ultimaker
#define DEFAULT_Kp 26.52 // 22.2
#define DEFAULT_Ki 2.51  // 1.08
#define DEFAULT_Kd 70.15 // 114
...
#define DEFAULT_bedKp 52.18  // 10.00
#define DEFAULT_bedKi 9.30   // .023
#define DEFAULT_bedKd 195.22 // 305.4
